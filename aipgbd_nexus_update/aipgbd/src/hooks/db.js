...
export const DEFAULT_CONFIG = {
  ...
  // ── Video Config ─────────────────────────────────────────────────────────
  videos: {
    nexusBgYoutubeId:  '_quzojxLBJw',
    studiosBgYoutubeId:'sEg2qr-TyY0',
    systemsBgYoutubeId:'RUorlCF5zH4',
    nexusBgOpacity:    0.35,
    studiosBgOpacity:  0.3,
    systemsBgOpacity:  0.25,
  },

  // ── Studios Content ───────────────────────────────────────────────────────
  studios: {
    heroTitle:    'Where Vision Becomes Cinema',
    heroSub:      'High-fidelity AI video production for brands that refuse to be ordinary. Cinematic quality. Infinite scale. Delivered in days, not months.',
    heroBtn1:     'View Our Work',
    heroBtn2:     'Start a Project',
    ctaTitle:     'Ready to Create Something Extraordinary?',
    ctaSub:       "Tell us about your project. We'll come back with a creative treatment, timeline, and quote within 24 hours.",
    ctaEmail:     'studios@aipgdbd.com',
    ctaWhatsapp:  'https://wa.me/8801XXXXXXXXX',
    stats: [
    ...
    services: [
      { icon: '🎬', title: 'Cinematic AI Video',    desc: 'Feature-quality AI video production — from brand films and product showcases to full narrative shorts.',          price: 'Starting from 15,000 BDT', tags: ['Sora','Runway','Kling','Pika'] },
      { icon: '🎵', title: 'AI Audio & Scoring',    desc: 'Original soundscapes, voiceovers, and full film scores synchronized perfectly to your visuals.',                  price: 'Starting from 8,000 BDT',  tags: ['Suno','ElevenLabs','Udio','Adobe'] },
      { icon: '🖼️', title: 'Visual Development',   desc: 'Concept art, storyboarding, style frames, and key visual creation using the latest diffusion models.',           price: 'Starting from 6,000 BDT',  tags: ['Midjourney','Flux','Stable Diffusion','Firefly'] },
      { icon: '✨', title: 'VFX & Compositing',     desc: 'AI-enhanced VFX, motion compositing, and post-production finishing. Professional-grade output.',                  price: 'Starting from 12,000 BDT', tags: ['After Effects','Topaz','Gemini','DaVinci'] },
      { icon: '📣', title: 'Social Content Engine', desc: 'Rapid-fire short-form content: Reels, TikToks, YouTube Shorts — scripted, generated, and scheduled.',            price: 'Starting from 5,000 BDT/mo',tags: ['Meta','YouTube','LinkedIn','Batch'] },
      { icon: '🎭', title: 'Brand Identity Films',  desc: 'Full-scale brand documentary and identity films. We craft the narrative arc and visual language.',                  price: 'Custom quote',             tags: ['Script','Direction','Grade','Delivery'] },
    ],
    showreel: [
      // Admin adds videos here: { id, title, youtubeId, category, description }
    ],
    portfolio: [
      { id:1, title:'Dhaka Neon — Brand Film',  cat:'Brand Film',    emoji:'🌆', description:'' },
      { id:2, title:'Synthwave Product Reel',   cat:'Product',       emoji:'🎛️', description:'' },
      { id:3, title:'FinTech Identity Film',    cat:'Corporate',     emoji:'💳', description:'' },
      { id:4, title:'AI Fashion Editorial',     cat:'Editorial',     emoji:'👗', description:'' },
      { id:5, title:'Pharma Documentary',       cat:'Documentary',   emoji:'🧬', description:'' },
      { id:6, title:'Restaurant Atmosphere',    cat:'Lifestyle',     emoji:'🍜', description:'' },
      { id:7, title:'Urban Architecture',       cat:'Architectural', emoji:'🏛️', description:'' },
    ],
    clients: [
      { logo:'🏢', name:'Bashundhara Properties', sector:'Real Estate'  },
      { logo:'💳', name:'Dhaka Fintech Co.',       sector:'FinTech'      },
      { logo:'👗', name:'Luxury Label BD',         sector:'Fashion'      },
      { logo:'🍽️', name:'The Rooftop Kitchen',    sector:'F&B'          },
      { logo:'🏗️', name:'BuildCo BD',             sector:'Construction' },
      { logo:'🌾', name:'AgroVision BD',           sector:'AgriTech'     },
    ],
    process: [
      { num:'01', title:'Brief & Vision',   desc:'We start with a deep-dive session to understand your brand, objectives, and creative vision.' },
      { num:'02', title:'Concept & Script', desc:'Our team crafts the narrative arc, visual style, and storyboard before generating a single frame.' },
      { num:'03', title:'AI Production',    desc:'Using a curated stack of cinematic AI tools, we generate and refine until every frame meets the brief.' },
      { num:'04', title:'Post & Grade',     desc:'VFX, colour grading, audio mixing, and final compositing — every output polished to broadcast standard.' },
      { num:'05', title:'Delivery',         desc:'All formats, all platforms. Export specs for social, broadcast, OOH, and web simultaneously.' },
    ],
    tech: ['Sora','Runway Gen-4','Kling','Pika 2.0','Midjourney v7','Flux Pro','Stable Diffusion XL','Adobe Firefly','ElevenLabs','Suno v4','Udio','Gemini','After Effects','DaVinci Resolve','Topaz AI','CapCut Pro'],
  },

  // ── Systems Content ───────────────────────────────────────────────────────
  systems: {
    heroTitle:    'Enterprise Software. Built to Last.',
    heroSub:      'Production-grade React and ASP.NET Core systems for healthcare, fintech, logistics, and edtech. Clean architecture, zero compromises.',
    heroBtn1:     'View Case Studies',
    heroBtn2:     'Start a Project',
    ctaTitle:     'Ready to Build Something That Lasts?',
    ctaSub:       "Share your requirements. We'll respond with a technical proposal and fixed-price quote within 48 hours.",
    ctaEmail:     'systems@aipgdbd.com',
    ctaWhatsapp:  'https://wa.me/8801XXXXXXXXX',
    stats: [
    ...
    services: [
      { icon:'⚛️', badge:'Frontend',  title:'React Application Development', desc:'Production-grade SPAs, dashboards, and portals built with React 18, TypeScript, and modern state management.', tags:['React 18','TypeScript','Redux','Tailwind','Vite'] },
      { icon:'🔧', badge:'Backend',   title:'ASP.NET Core APIs',              desc:'Robust REST and GraphQL APIs built on ASP.NET Core. Clean architecture, Entity Framework, SQL Server.',         tags:['ASP.NET Core','C#','EF Core','SQL Server','JWT'] },
      { icon:'🗄️', badge:'Database', title:'Database Architecture',          desc:'Schema design, query optimization, migrations, and data warehousing. Databases that perform at scale.',          tags:['SQL Server','PostgreSQL','Redis','Supabase','Azure SQL'] },
      { icon:'☁️', badge:'Cloud',     title:'Azure & Cloud Deployment',       desc:'Full CI/CD pipelines, containerization with Docker, and cloud infrastructure on Azure.',                         tags:['Azure','Docker','GitHub Actions','NGINX'] },
      { icon:'🔐', badge:'Security',  title:'Auth & Identity Systems',        desc:'Multi-tenant auth, OAuth2, OIDC, role-based access control, and audit trails for enterprise compliance.',         tags:['OAuth2','OIDC','RBAC','Azure AD','Identity Server'] },
      { icon:'📊', badge:'Analytics', title:'BI Dashboards & Reporting',      desc:'Real-time analytics dashboards, custom reporting engines, and data visualization tools.',                         tags:['Power BI','Recharts','D3.js','SSRS','SignalR'] },
    ],
    caseStudies: [
      { client:'MediTrack BD',    industry:'Healthcare', title:'Hospital Management System',         desc:'End-to-end HMS covering patient records, scheduling, pharmacy, billing, and lab management.',     tags:['ASP.NET Core','React','SQL Server','Azure'], metric:{val:'400+',label:'Beds Managed'},   metric2:{val:'12s',label:'Avg Page Load'} },
      { client:'FinEdge Capital', industry:'FinTech',    title:'Loan Origination & CRM Platform',    desc:'Multi-tenant SaaS for micro-finance with credit scoring, disbursement automation, and reporting.', tags:['React 18','C#','PostgreSQL','Docker'],       metric:{val:'৳2.4Cr',label:'Monthly Volume'},metric2:{val:'99.9%',label:'Uptime'} },
      { client:'RapidShip BD',    industry:'Logistics',  title:'Last-Mile Delivery Tracker',         desc:'Real-time parcel tracking, rider dispatch, route optimization, and merchant API.',                   tags:['SignalR','React','Maps API','Redis'],        metric:{val:'8,000+',label:'Parcels/Day'},  metric2:{val:'3ms',label:'Realtime Latency'} },
      { client:'EduNest',         industry:'EdTech',     title:'LMS & Live Class Platform',          desc:'Full LMS with video streaming, quiz engine, certificate generation, and parent portal.',             tags:['ASP.NET','React','Azure Media','Stripe'],   metric:{val:'25,000',label:'Students'},    metric2:{val:'4.9★',label:'App Rating'} },
    ],
    showreel: [
      // Admin adds videos here: { id, title, youtubeId, category, description }
    ],
    ...
    process: [
      { num:'01', title:'Discovery & Architecture', desc:'We map requirements, design the data model, and propose architecture before writing code.' },
      { num:'02', title:'Sprint Planning',           desc:'Features broken into 2-week sprints with clear acceptance criteria on a shared board.' },
      { num:'03', title:'Build & Review',            desc:'Clean code, code review, unit tests, and CI — every PR goes through a quality gate.' },
      { num:'04', title:'QA & UAT',                  desc:'Integration, regression, load testing, and structured UAT with your team.' },
      { num:'05', title:'Deploy & Monitor',          desc:'Zero-downtime Azure deployments with full observability — logs, metrics, alerts.' },
      { num:'06', title:'Support & Scale',           desc:'Ongoing maintenance and feature development under a transparent retainer agreement.' },
    ],
    tech: [
      {icon:'⚛️',name:'React',         cat:'Frontend'}, {icon:'🔷',name:'TypeScript',   cat:'Language'},
      {icon:'🟣',name:'ASP.NET Core',  cat:'Backend'},  {icon:'🔶',name:'C#',           cat:'Language'},
      {icon:'🗄️',name:'SQL Server',   cat:'Database'}, {icon:'🐘',name:'PostgreSQL',   cat:'Database'},
      {icon:'🔴',name:'Redis',         cat:'Cache'},    {icon:'☁️',name:'Azure',        cat:'Cloud'},
      {icon:'🐳',name:'Docker',        cat:'DevOps'},   {icon:'⚡',name:'Vite',         cat:'Tooling'},
      {icon:'🔄',name:'GitHub Actions',cat:'CI/CD'},    {icon:'📡',name:'SignalR',      cat:'Realtime'},
      {icon:'🔐',name:'Identity Server',cat:'Auth'},   {icon:'📊',name:'Power BI',     cat:'Analytics'},
      {icon:'🌿',name:'Supabase',      cat:'BaaS'},     {icon:'🧩',name:'EF Core',      cat:'ORM'},
    ],
  },

  // ── Nexus Landing ─────────────────────────────────────────────────────────
  nexus: {
    studiosLabel:   'Cinematic AI Production',
    studiosEyebrow: 'Division I',
    studiosSub:     'High-fidelity AI video production. From concept to final render — cinematic, precise, and unforgettable.',
    studiosBtn:     'Enter Studios',
    systemsLabel:   'Enterprise Software',
    systemsEyebrow: 'Division II',
    systemsSub:     'Production-grade React & ASP.NET solutions. Architected for scale, built to last.',
    systemsBtn:     'Enter Systems',
    centerLogoText: 'AIPG',
    centerLogoSub:  'AI Playground BD',
