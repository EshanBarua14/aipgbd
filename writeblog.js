...
const POSTS = [
  ...
  { id:'b3', slug:'restaurant-content-strategy-bangladesh', category:'Restaurant', title:'The Restaurant Guide to Viral Food Content in Bangladesh', title_bn:'ভাইরাল ফুড কন্টেন্টের জন্য রেস্তোরাঁ মালিকের গাইড', excerpt:'Restaurants that post 8 or more videos per month get 3x more table bookings without a film crew.', excerpt_bn:'মাসে ৮+ ভিডিও পোস্ট করা রেস্তোরাঁ ৩× বেশি টেবিল বুকিং পায়।', published:true, views:89, created_at:new Date(Date.now()-86400000*5).toISOString() },
  { id:'b4', slug:'elevenlabs-bangla-voiceover-guide', category:'Voiceover', title:'How ElevenLabs AI Is Changing Bangla Brand Communication', title_bn:'ElevenLabs এআই কীভাবে বাংলা ব্র্যান্ড কমিউনিকেশন বদলে দিচ্ছে', excerpt:'Studio-grade Bangla narration without hiring a voice actor. How AI voiceover works and why it sounds great.', excerpt_bn:'ভয়েস অ্যাক্টর ছাড়াই স্টুডিও-মানের বাংলা ন্যারেশন।', published:true, views:67, created_at:new Date(Date.now()-86400000*7).toISOString() },
  { id:'b5', slug:'startup-brand-identity-72-hours', category:'Startup', title:'How Dhaka Startups Get Investor-Ready Brand Kits in 72 Hours', title_bn:'কীভাবে ঢাকার স্টার্টআপগুলো ৭২ ঘণ্টায় বিনিয়োগকারী-প্রস্তুত ব্র্যান্ড কিট পাচ্ছে', excerpt:'A funding round is 3 days away. Your brand looks outdated. This is how founders fix it fast with AIPGBD.', excerpt_bn:'ফান্ডিং রাউন্ড ৩ দিন দূরে। ফাউন্ডাররা কীভাবে দ্রুত ঠিক করেন।', published:true, views:156, created_at:new Date(Date.now()-86400000*9).toISOString() },
  { id:'b6', slug:'ecommerce-product-video-bangladesh', category:'E-commerce', title:'Why Your E-commerce Store Loses Sales Without Product Video', title_bn:'কেন প্রোডাক্ট ভিডিও ছাড়া আপনার ই-কমার্স স্টোর বিক্রি হারাচ্ছে', excerpt:'Products with video convert at 3x the rate of products with photos only. Close the gap with AI.', excerpt_bn:'ভিডিও সহ প্রোডাক্ট শুধু ছবির তুলনায় ৩× বেশি কনভার্ট করে।', published:true, views:94, created_at:new Date(Date.now()-86400000*11).toISOString() },
  { id:'b7', slug:'facebook-video-algorithm-bangladesh', category:'Social Media', title:'How the Facebook Algorithm Rewards Video Content in Bangladesh', title_bn:'Facebook অ্যালগরিদম কীভাবে বাংলাদেশে ভিডিও কন্টেন্টকে পুরস্কৃত করে', excerpt:'Facebook Reels get 3x the organic reach of image posts. Make the algorithm work for your brand.', excerpt_bn:'Facebook Reels ইমেজ পোস্টের তুলনায় ৩× বেশি অর্গানিক রিচ পায়।', published:true, views:178, created_at:new Date(Date.now()-86400000*13).toISOString() },
  { id:'b8', slug:'ai-tools-stack-explained', category:'AI Production', title:'Inside the AIPGBD Stack: How 7 AI Tools Create One Cinematic Video', title_bn:'AIPGBD স্ট্যাকের ভেতরে: কীভাবে ৭টি এআই টুল একটি ভিডিও তৈরি করে', excerpt:'Gemini generates the image. Grok animates it. Canva brands it. Suno scores it. ElevenLabs voices it.', excerpt_bn:'Gemini ছবি তৈরি করে। Grok অ্যানিমেট করে। Canva ব্র্যান্ড করে।', published:true, views:231, created_at:new Date(Date.now()-86400000*15).toISOString() },
  { id:'b9', slug:'website-vs-facebook-page-bangladesh', category:'Web Development', title:'Facebook Page vs Website: What Every Bangladeshi Business Needs', title_bn:'Facebook পেজ বনাম ওয়েবসাইট: প্রতিটি বাংলাদেশি ব্যবসার কী দরকার', excerpt:'Most businesses rely only on Facebook and WhatsApp. Here is why that strategy has a ceiling.', excerpt_bn:'বেশিরভাগ ব্যবসা Facebook ও WhatsApp-এর উপর নির্ভর করে।', published:true, views:112, created_at:new Date(Date.now()-86400000*17).toISOString() },
  ...
  { id:'b14', slug:'seo-for-bangladeshi-businesses', category:'Web Development', title:'Why Your Bangladeshi Business Is Invisible on Google', title_bn:'কেন আপনার বাংলাদেশি ব্যবসা Google-এ অদৃশ্য', excerpt:'Most Bangladeshi businesses have no Google presence. A properly built website fixes this permanently.', excerpt_bn:'বেশিরভাগ বাংলাদেশি ব্যবসার Google উপস্থিতি নেই।', published:true, views:98, created_at:new Date(Date.now()-86400000*27).toISOString() },
  { id:'b15', slug:'whatsapp-business-integration-website', category:'Web Development', title:'How WhatsApp Integration Turns Your Website Into a 24/7 Sales Machine', title_bn:'WhatsApp ইন্টিগ্রেশন কীভাবে আপনার ওয়েবসাইটকে ২৪/৭ সেলস মেশিনে পরিণত করে', excerpt:'Bangladeshi customers prefer WhatsApp over contact forms. Route every visitor directly to your sales chat.', excerpt_bn:'বাংলাদেশি গ্রাহকরা কন্টাক্ট ফর্মের চেয়ে WhatsApp পছন্দ করেন।', published:true, views:145, created_at:new Date(Date.now()-86400000*29).toISOString() },
  { id:'b16', slug:'virtual-influencer-bangladesh-brands', category:'AI Production', title:'The Rise of Virtual Influencers in Bangladesh', title_bn:'বাংলাদেশে ভার্চুয়াল ইনফ্লুয়েন্সারের উদয়', excerpt:'A virtual influencer never has a scandal, never asks for more money, and works around the clock.', excerpt_bn:'একজন ভার্চুয়াল ইনফ্লুয়েন্সার কখনো কেলেঙ্কারি করে না।', published:true, views:189, created_at:new Date(Date.now()-86400000*31).toISOString() },
  { id:'b17', slug:'ai-vs-traditional-agency-cost', category:'AI Production', title:'AI Production vs Traditional Agency: A Brutally Honest Cost Comparison', title_bn:'এআই প্রোডাকশন বনাম প্রচলিত এজেন্সি: একটি নির্মম সৎ মূল্য তুলনা', excerpt:'One 30 second video: agency 80,000 to 1,50,000 BDT vs AIPGBD 8,000 BDT. The numbers are not close.', excerpt_bn:'প্রচলিত এজেন্সি বনাম AIPGBD: প্রতিটি লাইন আইটেম পাশাপাশি।', published:true, views:312, created_at:new Date(Date.now()-86400000*33).toISOString() },
  { id:'b18', slug:'mobile-first-website-bangladesh', category:'Web Development', title:'Why Mobile-First Website Design Is Non-Negotiable in Bangladesh', title_bn:'কেন বাংলাদেশে মোবাইল-ফার্স্ট ওয়েবসাইট ডিজাইন অপরিহার্য', excerpt:'92 percent of internet users in Bangladesh access the web via mobile. Design for them first.', excerpt_bn:'বাংলাদেশের ৯২% ইন্টারনেট ব্যবহারকারী মোবাইলে ওয়েব অ্যাক্সেস করেন।', published:true, views:78, created_at:new Date(Date.now()-86400000*35).toISOString() },
  { id:'b19', slug:'content-marketing-roi-bangladesh', category:'Social Media', title:'The ROI of Content Marketing for Bangladeshi SMEs: Real Numbers', title_bn:'বাংলাদেশি SME-র জন্য কন্টেন্ট মার্কেটিংয়ের ROI', excerpt:'A restaurant investing 18,000 BDT per month in video content sees 177 percent ROI in 90 days.', excerpt_bn:'মাসে ১৮,০০০ টাকা বিনিয়োগে ১৭৭% ROI।', published:true, views:223, created_at:new Date(Date.now()-86400000*37).toISOString() },
  { id:'b20', slug:'how-to-brief-ai-production-studio', category:'AI Production', title:'How to Brief an AI Production Studio: Getting the Best Results', title_bn:'কীভাবে একটি এআই প্রোডাকশন স্টুডিও ব্রিফ করবেন', excerpt:'The quality of your brief determines the quality of your output. Five elements every good brief needs.', excerpt_bn:'আপনার ব্রিফের মান আউটপুটের মান নির্ধারণ করে।', published:true, views:56, created_at:new Date(Date.now()-86400000*39).toISOString() },
];
...
function PostCard({ post, lang }) {
  ...
  const date    = new Date(post.created_at).toLocaleDateString('en-BD',{day:'numeric',month:'short',year:'numeric'});
  return (
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="animate-in" style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'2rem'}}>
            {categories.map(c=>(
              <button key={c} onClick={()=>setFilter(c)} style={{padding:'0.3em 0.9em',borderRadius:'100px',fontFamily:'var(--font-mono)',fontSize:'0.65rem',letterSpacing:'0.08em',border:\`1px solid \${filter===c?'var(--cyan-mid)':'var(--border)'}\`,background:filter===c?'var(--cyan-dim)':'transparent',color:filter===c?'var(--cyan)':'var(--text-2)',transition:'all 0.2s',cursor:'pointer'}}>
                {c}
              </button>
            ))}
          </div>
...
fs.writeFileSync('src/pages/BlogPage.js', content);
console.log('Written:', fs.statSync('src/pages/BlogPage.js').size, 'bytes');
