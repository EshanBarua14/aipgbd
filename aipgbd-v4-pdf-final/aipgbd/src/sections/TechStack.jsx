...
const ACCENTS = ['#378ADD','#5DCAA5','#9F77DD','#C9A84C','#D85A30'];
    ...
    <section id="specs" className="ts section-pad">
      <div className="container">
        <div className={`reveal ${v ? 'visible' : ''}`} ref={ref}>
          ...
          <p className="ts__sub">Every tool chosen because it outperforms everything else at its specific job. Together they form a production system no traditional agency can replicate.</p>
        </div>
        ...
        {/* Verify Tech button — from PDF */}
        <div className="ts__footer">
          <a
            href="https://docs.aipgbd.com"
            target="_blank"
            rel="noreferrer"
            className="ts__verify-btn"
          >
            <span className="ts__verify-dot" />
            Verify Tech Stack — API Documentation
            <span>↗</span>
          </a>
