...
function AppInner() {
  ...
  return (
    <>
      ...
      <Navbar cfg={cfg} theme={theme} toggleTheme={() => setTheme(t => t === 'dark' ? 'light' : 'dark')} openAdmin={() => setAdminOpen(true)} />

      <Routes>
        <Route path="/"              element={<HomePage cfg={cfg} cfgKey={cfgKey} showToast={showToast} />} />
      ...
      <Footer cfg={cfg} />
      <CookieBar />
      {cfg.chatbot?.enabled !== false && <Chatbot cfg={cfg} />}
